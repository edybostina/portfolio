...
export const posts = [
    {
        ...
        content: [
            ...
            'The thing I did not appreciate yet is that the YAML is the easy part.'
        ]
    },
    {
    ...
    },
    {
        ...
        content: [
            ...
            'I sent DSP and IVA as a pair. The review came back from Krzysztof Kozlowski and it was blunt in the way that upstream review is blunt when you have missed the point. I had invented a "ti,iva" compatible that did not need to exist, and I had written the schema so that "ti,ivahd" was, as he put it, both compatible and not compatible at the same time. I had also quietly folded in a handful of unrelated improvements I had noticed along the way.',
