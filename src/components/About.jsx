  ...
  return (
    <section id="about" className="card">
      ...
      <div style={{display:'flex', gap:12, alignItems:'center'}}>
        <img className="avatar" src="pfp2.jpg" alt="avatar" />
        <div>
          ...
          <p className="small">Skills: C · C++ · C# · Python · MATLAB · Java · Javascript · Shell · CSS</p>
          <p className="small">Interests: Music · Sports · Technology · Gaming</p>
        </div>
      </div>
    </section>
  )
